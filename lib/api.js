...
export const useApi = () => {
  return {
    ...
    collections: {
      ...
      get: (workspaceId, collectionId, email) =>
        axiosInstance.get(
          `/workspaces/${workspaceId}/collections/${collectionId}/user/${email}`
        ),
    ...
    agent: {
      ...
      askQuestion: (
        ...
        axiosInstance.post(`/agent/ask-agent`, {
          collectionId,
          question,
    ...
    flashcards: {
      listByCollection: (workspaceId, collectionId, email) =>
        axiosInstance.get(
      ...
      update: (workspaceId, collectionId, flashcardId, flashcard, email) =>
        axiosInstance.put(
      ...
      getStats: (workspaceId, collectionId, email) =>
        axiosInstance.get(
          `/workspaces/${workspaceId}/collections/${collectionId}/flashcards/stats/user/${email}`
        ),
